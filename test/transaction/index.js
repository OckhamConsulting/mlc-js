...
describe("transaction.js", function () {
  ...
  var transaction = mlc.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    it("should create transaction without second signature from keys", function () {
      var secretKey = mlc.ECPair.fromSeed("secret");
    ...
    describe("returned transaction", function () {
      ...
      it("should be signed correctly", function () {
        var result = mlc.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx = mlc.crypto.fromBytes(mlc.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      var old_transaction = mlc.transaction.createTransaction('AacRfTLtxAkR3Mind1XdPCddj1uDkHtwzD', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " + mlc.crypto.getId(old_transaction));
      // console.log("VERIFY " + mlc.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

      mlc.crypto.verify(old_transaction).should.equal(true);
      ...
      mlc.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys = mlc.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result = mlc.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
