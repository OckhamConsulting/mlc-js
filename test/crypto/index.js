...
describe("different networks", function () {
  ...
  it("validate address on tesnet should be ok", function () {
    mlc.crypto.setNetworkVersion(0x52);
    mlc.crypto.getNetworkVersion().should.equal(0x52);
    var validate = mlc.crypto.validateAddress("a6fpb1BJZq4otWiVsBcuLG1ZGs5WsqqQtH");
    (validate).should.equal(true);
    mlc.crypto.setNetworkVersion(0x17);
    mlc.crypto.getNetworkVersion().should.equal(0x17);
  });
});

describe("delegate.js", function () {
  var delegate = mlc.delegate;
  ...
  describe("#createDelegate", function () {
    ...
    describe("returned delegate", function () {
      var keys = mlc.crypto.getKeys("secret");
      var secondKeys = mlc.crypto.getKeys("secret 2");
      ...
      it("should be second signed correctly", function () {
        var result = mlc.crypto.verifySecondSignature(trs, secondKeys.publicKey);
        (result).should.be.ok;
      });
